...
public class RadioTest {
    ...
    @Test
    public void setCurrentVolume_Above100_ShouldSetTo100() {
        Radio radio = new Radio();
        radio.setCurrentVolume(100);
    ...
    @Test
    public void setVolum_To101_ShouldClampTo100() {
        Radio radio = new Radio();
        radio.setCurrentVolume(100);
    ...
    @Test
    public void setVolume_ToMinus1_ShouldClampTo0() {
        Radio radio = new Radio();
        radio.setCurrentVolume(0);
    ...
    @Test
    public void nextStation_From9_To_0Test() {
        Radio radio = new Radio();
        radio.setCurrentStation(9);
    ...
    @Test
    public void shouldWrapToZeroWhenNextFromMa() {
    ...
    @Test
    public void ShouidWrapToMaxWhenPrevFromZero() {
        Radio radio = new Radio(10);
        radio.setCurrentStation(0);
    ...
    @Test
    public void shouldIgnoreInvalidStation() {
        Radio radio = new Radio(10);
    ...
    @Test
    public void shiuldFallbackToDefaultWhenInvalidCount() {
